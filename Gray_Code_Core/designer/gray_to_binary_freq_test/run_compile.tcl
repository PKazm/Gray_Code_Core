...
set_compile_info \
    ...
    -name {"Topcell"} \
    -value {"gray_to_binary_freq_test"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Format"} \
    -value {"Verilog"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"E:\Github_Repos\Gray_Code_Core\Gray_Code_Core\synthesis\gray_to_binary_freq_test.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {E:\Github_Repos\Gray_Code_Core\Gray_Code_Core\designer\gray_to_binary_freq_test} \
    -design gray_to_binary_freq_test \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -merge_pdc 0 \
