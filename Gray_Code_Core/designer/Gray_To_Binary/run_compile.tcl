...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"E:\Github_Repos\Gray_Code_Core\Gray_Code_Core\synthesis\Gray_To_Binary.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {E:\Github_Repos\Gray_Code_Core\Gray_Code_Core\designer\Gray_To_Binary} \
    -design Gray_To_Binary \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
    -merge_pdc 0 \
