...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"E:\Github_Repos\Gray_Code_Core\Gray_Code_Core\synthesis\Gray_Code_Counter.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {E:\Github_Repos\Gray_Code_Core\Gray_Code_Core\designer\Gray_Code_Counter} \
